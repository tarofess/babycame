...
SWIFT_CLASS("_TtC8babyCame12AVPlayerView")
...
SWIFT_CLASS("_TtC8babyCame11AppDelegate")
...
@interface GameViewController : UIViewController <AVCaptureFileOutputRecordingDelegate>
@property (nonatomic, weak) IBOutlet UINavigationBar * __null_unspecified navigationBar;
@property (nonatomic, readonly, strong) AVCaptureSession * __nonnull captureSession;
@property (nonatomic, readonly, strong) AVCaptureDevice * __null_unspecified videoDevice;
@property (nonatomic, readonly, strong) AVCaptureDevice * __null_unspecified audioDevice;
@property (nonatomic, readonly, strong) AVCaptureMovieFileOutput * __nonnull fileOutput;
@property (nonatomic, strong) NSTimer * __null_unspecified timer;
@property (nonatomic) NSInteger timeLeft;
@property (nonatomic) BOOL didTouchScreenOnce;
- (void)viewDidLoad;
...
- (void)startRecording;
- (void)updateTime;
- (void)showCompletionAlert:(NSURL * __nonnull)videoPath;
- (void)setUpCamera;
...
@property (nonatomic, strong) IBOutlet AVPlayerView * __null_unspecified playerView;
@property (nonatomic, strong) AVPlayer * __null_unspecified videoPlayer;
@property (nonatomic, strong) NSURL * __null_unspecified videoPath;
- (void)viewDidLoad;
- (void)viewDidAppear:(BOOL)animated;
- (void)didReceiveMemoryWarning;
- (IBAction)didTapBackButton:(id __nonnull)sender;
- (IBAction)didTapActionButton:(id __nonnull)sender;
- (void)playMovie;
- (void)showBackActionSheet;
- (void)showShareActionSheet;
- (void)saveMovieToCameraRoll;
- (void)showSavedVideoConfirmAlert;
- (nonnull instancetype)initWithNibName:(NSString * __nullable)nibNameOrNil bundle:(NSBundle * __nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
- (void)prepareForSegue:(UIStoryboardSegue * __nonnull)segue sender:(id __nullable)sender;
- (IBAction)unwindToTop:(UIStoryboardSegue * __nonnull)segue;
- (nonnull instancetype)initWithNibName:(NSString * __nullable)nibNameOrNil bundle:(NSBundle * __nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
